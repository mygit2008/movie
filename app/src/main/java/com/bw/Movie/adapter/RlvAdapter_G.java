...
public class RlvAdapter_G extends RecyclerView.Adapter {
    private Context context;
    private List<RecommendCinemaBean.ResultBean.FollowCinemasBean> list;
    ...
    public RlvAdapter_G(Context context, List<RecommendCinemaBean.ResultBean.FollowCinemasBean> list) {
...
//        }
        ...
        int i = distance / 1000;
        myviewholder.adress_tv.setText(i+" km");
