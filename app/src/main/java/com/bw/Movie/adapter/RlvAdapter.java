...
public class RlvAdapter extends RecyclerView.Adapter {
    ...
    private List<RecommendCinemaBean.ResultBean.NearbyCinemaListBean> list;
    ...
    public RlvAdapter(Context context, List<RecommendCinemaBean.ResultBean.NearbyCinemaListBean> list) {
